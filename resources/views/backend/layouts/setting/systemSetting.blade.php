                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="logo" id="logoInput" hidden onchange="previewImage(this, 'logoPreview')">
                            @error('logo')<div class="text-danger mt-1">{{ $message }}</div>@enderror
                            <small class="form-text text-muted">uplode new logo.</small>
                        </div>

                        <!-- Favicon -->
                        <div class="mb-4">
                            <label class="form-label">Favicon</label>
                            <div class="image-upload-wrapper" onclick="document.getElementById('faviconInput').click()">
                            ...
                            <input type="file" name="favicon" id="faviconInput" hidden onchange="previewImage(this, 'faviconPreview')">
                            @error('favicon')<div class="text-danger mt-1">{{ $message }}</div>@enderror
                            <small class="form-text text-muted">uplode new Favicon</small>
                        </div>
                    </div>
